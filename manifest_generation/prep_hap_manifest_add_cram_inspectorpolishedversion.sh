...
# Manifest produced by the previous step (NEW context)
MANIFEST="/lustre10/home/raulnmateos/Japanese_Pangenome/Pipeline/Figure_2/required_data/Manifest/hap_manifest_inspector_corrected.tsv"
